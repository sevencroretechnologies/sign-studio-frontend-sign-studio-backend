        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card className="border-0 shadow-sm">
            <CardContent className="p-4">
              <div className="text-sm text-solarized-base01">Total Hours</div>
              <div className="text-2xl font-bold text-solarized-blue">
                {formatTotalHours(overallStats.totalHours)}
              </div>
            </CardContent>
          </Card>
          <Card className="border-0 shadow-sm">
            <CardContent className="p-4">
              ...
              <div className="text-2xl font-bold text-solarized-cyan">
                {formatTotalHours(overallStats.averageHours)}
              </div>
            </CardContent>
          </Card>
        </div>
                      ...
                      return (
                        <TableRow key={log.id} className="hover:bg-solarized-base3/50">
                          ...
                          <TableCell>
                            <div className="flex items-center gap-2">
                              {log.clock_in_image ? (
                                <img src={`http://127.0.0.1:8000/storage/${log.clock_in_image}`} alt="In" className="w-6 h-6 rounded-full object-cover" />
                              ) : (
                          ...
                          <TableCell>
                            <div className="flex items-center gap-2">
                              {log.clock_out_image ? (
                                <img src={`http://127.0.0.1:8000/storage/${log.clock_out_image}`} alt="Out" className="w-6 h-6 rounded-full object-cover" />
                              ) : (
                          ...
                          <TableCell>
                            <div className={`font-medium ${log.late_minutes > 0 ? 'text-solarized-yellow' : 'text-solarized-green'}`}>
                              {safeNumberFormat((log.late_minutes || 0) / 60, 1)}h
                            </div>
                          </TableCell>
