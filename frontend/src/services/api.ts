...
export const staffService = {
  ...
  getAllForAttendance: (params?: {
    ...
    department_id?: number | string;
    status?: string;
  }) => api.get('/staff-members-attendance', { params }),
...
export const attendanceService = {
  ...
  clearWorkLogStatus: (id: number) => api.post(`/work-logs/${id}/clear-status`),
  ...
  getMonthlyAttendance: (staffMemberId: number, params?: Record<string, unknown>) =>
    api.get(`/attendance/staff/${staffMemberId}/monthly`, { params }),

  // Dashboard report
  getDashboardReport: (params?: Record<string, unknown>) =>
    api.get('/attendance/dashboard-report', { params }),

  // Historical Attendance for Employee
  getStaffHistoricalAttendance: (staffMemberId: number, params?: Record<string, unknown>) =>
    api.get(`/attendance/staff/${staffMemberId}/history`, { params }),
...
export const leaveService = {
  ...
  getRequests: (params?: Record<string, unknown>) => api.get('/time-off-requests', { params }),
...
export const settingsService = {
  getOfficeLocations: (params?: { page?: number; per_page?: number; search?: string; paginate?: string | boolean }) => api.get('/office-locations', { params }),
  ...
  getDivisions: (params?: { page?: number; per_page?: number; search?: string; order_by?: string; order?: string; paginate?: string | boolean }) => api.get('/divisions', { params }),
...
export const workingDaysService = {
  getAll: (params?: Record<string, unknown>) => api.get('/working-days', { params }),
  getById: (id: number) => api.get(`/working-days/${id}`),
  create: (data: Record<string, unknown>) => api.post('/working-days', data),
  update: (id: number, data: Record<string, unknown>) => api.put(`/working-days/${id}`, data),
  delete: (id: number) => api.delete(`/working-days/${id}`),
};