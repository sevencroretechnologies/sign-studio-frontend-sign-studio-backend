...
class DataImportController extends Controller
{
    ...
    public function template(Request $request)
    {
        ...
        $templates = [
            'staff_members' => [
                'columns' => ['first_name', 'last_name', 'personal_email', 'phone_number', 'date_of_birth', 'gender', 'date_of_joining', 'base_salary', 'office_location', 'division', 'job_title'],
                'sample' => [
        ...
        while (($data = fgetcsv($handle)) !== false) {
            ...
            try {
                ...
                StaffMember::create([
                    ...
                    'date_of_joining' => ! empty($mapped['date_of_joining']) ? Carbon::parse($mapped['date_of_joining']) : now(),
