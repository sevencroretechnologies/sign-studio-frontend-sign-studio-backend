...
class JobController extends Controller
{
    ...
    {
        return $this->success($job->load(['category', 'officeLocation', 'division'])->loadCount('applications'));
    }
    ...
    public function updateQuestion(Request $request, CustomQuestion $question)
    {
        $validator = Validator::make($request->all(), [
        ...
        $question->update($request->only(['question', 'is_required']));

        return $this->success($question, 'Question updated successfully');
    }

    public function deleteQuestion(CustomQuestion $question)
    {
        $question->delete();

        return $this->noContent('Question deleted successfully');
    }
}
