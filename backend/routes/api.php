...
use App\Http\Controllers\Api\Attendance\LateComingPolicyController;
...
use App\Http\Controllers\Api\Staff\StaffBankDetailController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/staff-members-attendance', [StaffMemberController::class, 'attendanceIndex'])->middleware('permission:view_staff');
    ...
    // Staff Bank Details
    Route::get('/staff-bank-details', [StaffBankDetailController::class, 'index'])->middleware('permission:view_staff');
    Route::get('/staff-bank-details/{id}', [StaffBankDetailController::class, 'show'])->middleware('permission:view_staff');
    Route::post('/staff-bank-details', [StaffBankDetailController::class, 'store'])->middleware('permission:edit_staff');
    Route::put('/staff-bank-details/{id}', [StaffBankDetailController::class, 'update'])->middleware('permission:edit_staff');
    Route::delete('/staff-bank-details/{id}', [StaffBankDetailController::class, 'destroy'])->middleware('permission:edit_staff');
    ...
    Route::post('/work-logs/{workLog}/clear-status', [WorkLogController::class, 'clearStatus']);
    ...
    Route::get('/attendance/late-coming-policy', [LateComingPolicyController::class, 'show']);
    Route::post('/attendance/late-coming-policy', [LateComingPolicyController::class, 'update']);
    Route::get('/attendance/dashboard-report', [WorkLogController::class, 'dashboardReport'])->middleware('permission:view_attendance');
    Route::get('/attendance/staff/{id}/history', [WorkLogController::class, 'staffHistory'])->middleware('permission:view_attendance');
    Route::get('/attendance/staff/{id}/monthly', [WorkLogController::class, 'monthlyAttendance'])->middleware('permission:view_attendance');
    // ============================================
    ...
    Route::prefix('permissions')->middleware('permission:view_roles')->group(
        function () {
    ...
    Route::prefix('resources')->middleware('permission:view_roles')->group(
        function () {
